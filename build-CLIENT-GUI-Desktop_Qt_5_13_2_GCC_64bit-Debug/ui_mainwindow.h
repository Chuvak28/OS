...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(110, 41, 232, 161));
        ...
        lineEdit_IP_Adress = new QLineEdit(widget);
        ...
        lineEdit_Port_No = new QLineEdit(widget);
        ...
        lineEdit_Display_PATH = new QLineEdit(widget);
